    ...
    Arguments:
        ...
        stateful_metrics: Iterable of string names of metrics that should
            *not* be averaged over time. Metrics in this list will be
            displayed as-is. All others will be averaged by the progbar before
            display.
    ...
    def update(self, current, values=None, finalize=None):
        ...
        for k, v in values:
            ...
            if k not in self.stateful_metrics:
                ...
                # the first
                # epoch, both on_batch_end and on_epoch_end will be called,
                # which will cause 'current' and 'self._seen_so_far' to have
                # the same value. Force
                # the minimal value to 1 here, otherwise stateful_metric will
                # be 0s.
